...
export const BRAND_RULES: BrandRule[] = [
  ...
  { key: "mdt.versaone-optical", kind: "brand", match: /\bversaone\b[^;]*\boptical\b/i, assert: { visualization: "optical", tip: "bladeless", component: "trocar", line: "VersaOne", manufacturer: "Medtronic" }, provenance: "manufacturer description", note: "VersaOne Optical is a bladeless optical-entry trocar" },
  ...
  { key: "mdt.versaport-sleeve", kind: "brand", match: /\bversaport\b[^;]*\b(?:sleeve|cannula)\b/i, unless: /\btrocar\b|\bobturator\b/i, assert: { component: "cannula", line: "Versaport", manufacturer: "Medtronic" }, provenance: "manufacturer description", note: "Versaport 'Sleeve' / 'Fixation Cannula' SKUs are cannula-only" },
  ...
  // ---- Generic wording ---------------------------------------------------------------------
  { key: "generic.optical", kind: "brand", match: /\boptical\b|\bclear\s+tip\b|\bvisual(?:ised|ized)?\s+entry\b/i, assert: { visualization: "optical" }, provenance: "manufacturer description", note: "'optical' / 'clear tip' names visualised entry" },
  ...
  { key: "generic.bladed", kind: "brand", match: /\bbladed\b(?!\s*less)|\bshielded\s+blade\b|\bpyramidal\s+tip\b/i, assert: { tip: "bladed" }, provenance: "manufacturer description", note: "stated bladed / pyramidal tip" },
  ...
  { key: "generic.bladed-nonoptical", kind: "brand", match: /\bbladed\b(?!\s*less)|\bnon-?shielded\b|\bshielded\s+blade\b/i, assert: { visualization: "non-optical" }, provenance: "manufacturer description", note: "a bladed trocar is non-optical unless the name says optical (the optical rules run first)" },
  ...
  { key: "generic.fixation", kind: "brand", match: /\bfixation\b|(?<!non-)(?<!non\s)\bthreaded\b|\bridged\b|\bstability\s+sleeves?\b/i, assert: { fixation: "fixation" }, provenance: "manufacturer description", note: "threaded / ridged / fixation cannula" },
