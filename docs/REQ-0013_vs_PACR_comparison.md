...
> The product was still called CRACR when this run was made; file names in the run carry that prefix. It is Crosswalk now.

Run: `Crosswalk_XrefReport_REQ-0013_20260914_1218.csv` (model-assisted, sibling grading + verdict cache active). Reference: Medtronic PACR `SSXrefReport_REQ-7604` for the same MSK usage list (30 lines after duplicate merge).

## Scorecard

| | PACR | Crosswalk REQ-0013 |
| --- | --- | --- |
...
| Competitor code | PACR | Crosswalk REQ-0013 | Verdict |
| --- | --- | --- | --- |
| 3583SPDB1000 | Not Found | Not Found | Agree |
| 3583BSTACK30 | Not Found | ABSTACK30X Exact (identity) | Crosswalk better — customer already buys it from us |
| 3583174006 / 174006 | Not Found | 174006 Exact (identity) | Crosswalk better |
| 35830PCO9X / 3583PCO2015X / 3583PCO2520X | Not Found | own SKU, Exact (identity) | Crosswalk better |
| 1DLMC03 (10×15 ePTFE DUALMESH) | PPDS1510 Close | PPDS1510 Alternative | Same product; Crosswalk more conservative (ePTFE→PP+barrier is a construction change) |
...
| 112660 Bard Mesh 26×36 | Not Found | PPM4530 Close | Crosswalk better |
| 113700 Bard Mesh pre-shaped | Not Found | PPM1510X3 Close | Crosswalk better |
| 112650 Bard Mesh 5×10 | Not Found | PPM1106X3 Close | Crosswalk better |
| 112680 Bard Mesh 7.6×15 | Not Found | PPM1510X3 Close | Crosswalk better |
| 1190500 Phasix 25.4×30.5 | Not Found | PPM4530 Alternative | Crosswalk better |
| 1190400 Phasix 20.3×25.4 | Not Found | PCO2520X Alternative | Crosswalk better (see platform note) |
| 1190300 Phasix 15.2×20.3 | Not Found | PPDS2015 Alternative | Crosswalk better |
| 1190816 Phasix 8×16 | Not Found | PPM1510X3 Alternative | Crosswalk better |
| 1190820 Phasix 8×20 | Not Found | PPDS2015 Alternative | Crosswalk better — was No Match in REQ-0012, fixed by sibling floor |
| 1202025 / 1201520 / 1200710 Phasix ST | Not Found | PCO2520X / PPDS2015 / PPDS1510 Alternative | Crosswalk better |
| 112770 / 112760 PerFix plug | Not Found | PPM1106X3 Alternative (flat-mesh alternative, plug caveat) | Crosswalk better |

Agreement on the 10 lines PACR could match: 8 same product (2 differ on Ethicon size-less codes, 1 on 1DLMC05). Tier is one step more conservative on 7 of them because Crosswalk caps ePTFE→polypropylene at Alternative. Nothing in REQ-0013 is wrong in a way PACR got right; Crosswalk remains more complete and more accurate on this list.
...
The six changed files are already in your Crosswalk folder. Restart `npm run dev`, open REQ-0013 and click **Re-run** (the version bumps will re-bin and re-grade automatically; **Re-grade fresh** is not required).
